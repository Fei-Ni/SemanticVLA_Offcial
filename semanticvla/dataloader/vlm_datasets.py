...
from semanticvla.dataloader.qwenvl_llavajson.qwen_data_config import data_list
from semanticvla.dataloader.qwenvl_llavajson.rope2d import get_rope_index_25, get_rope_index_2
...
def _require_decord():
    if VideoReader is None:
        raise ImportError(
            "decord is required for VLM video loading. Install decord or avoid video-based VLM datasets."
        )

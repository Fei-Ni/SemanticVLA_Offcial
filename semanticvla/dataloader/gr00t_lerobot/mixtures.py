...
Defines a registry of dataset mixtures and weights. Each mix maps a name to a
list of `(dataset_name, sampling_weight, robot_type)` tuples consumed by the
LeRobot-style dataloader.
"""
...
#   {mix_name: [(data_name, sampling_weight, robot_type)]}

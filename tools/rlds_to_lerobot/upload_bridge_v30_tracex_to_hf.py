#!/usr/bin/env python3
"""Upload the experimental Bridge TraceX LeRobot v3.0 package to Hugging Face."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--repo-id", default=os.environ.get("TRACEX_BRIDGE_V30_REPO_ID", DEFAULT_REPO_ID))
